...
export const addToFav = (userName,
    userImage,
    nombre,
    marca,
    precio,
  ...
  export const addToCart = (
    ...
    if(cart === null || !cart.length){
        localStorage.setItem("cartList", JSON.stringify([{  userName,
            userImage,
            nombre,
            marca,
            precio,
        ...
        if(found){
            ...
            localStorage.setItem("cartList", JSON.stringify([...cart,{  userName,
                userImage,
                nombre,
                marca,
                precio,
