        ...
        <Box width={{ xs: "100%", md: "50%" }}>
          ...
          <div>
            <Accordion expanded={expanded === "panel1"} onChange={handleChange("panel1")}>
              ...
              >
                <Typography fontWeight={"bold"}>Términos y Condiciones</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  Estos términos y condiciones y los anexos que explican los servicios del
                  Eccomerce IPHONECASEOBERA (de ahora en más: “Términos y Condiciones”)
                  regulan la relación entre IPHONECASEOBERA y las personas que usan sus
                  servicios (“Personas Usuarias”). <br />
                  <br />
                  Las Personas Usuarias aceptan estos Términos y Condiciones desde el
                  momento en que se registran en el Sitio y usan el Eccomerce
                  IPHONECASEOBERA.
                  <br />
                  <br />
                  ...
                  Eccomerce IPHONECASEOBERA. El plazo será de 5 días corridos en caso de
                  que tengamos que actualizar las tarifas de nuestros servicios. En ningún
                  caso afectarán las operaciones que ya hayan finalizado.
                  <br />
                  Las Personas Usuarias que no tengan obligaciones pendientes con
                  IPHONECASEOBERA o con otras Personas Usuarias, podrán finalizar la
                  relación con IPHONECASEOBERA cancelando su cuenta.
                  <br />
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === "panel2"} onChange={handleChange("panel2")}>
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  edad que autorice.
                  <br />
                  Quien use el Eccomerce IPHONECASEOBERA en representación de una empresa
                  deberá tener capacidad para contratar a nombre de ella. Además, para
            ...
            <Accordion expanded={expanded === "panel3"} onChange={handleChange("panel3")}>
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  Usuaria.
                  <br /> La cuenta es personal, única e intransferible, es decir que bajo
                  ningún concepto se podrá vender o ceder a otra persona. Se accede a ella
                  con la clave personal de seguridad que haya elegido y que deberá
                  mantener bajo estricta confidencialidad.
                  <br />
                  En cualquier caso, la Persona Usuaria será la única responsable por las
                  operaciones que se realicen en su cuenta. En caso de detectar un uso no
                  autorizado de su cuenta, deberá notificar de forma inmediata y
                  fehaciente a IPHONECASEOBERA. <br />
                  ...
                  Sitio, más allá de las sanciones que pudieran corresponder.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === "panel4"} onChange={handleChange("panel4")}>
              ...
              <AccordionDetails>
                <Typography>
                  En IPHONECASEOBERA hacemos un uso responsable de la información
                  personal, protegiendo la privacidad de las Personas Usuarias que nos
                  confiaron sus datos y tomando las medidas necesarias para garantizar la
                  seguridad en nuestro Eccomerce IPHONECASEOBERA.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === "panel6"} onChange={handleChange("panel6")}>
              ...
              <AccordionDetails>
                <Typography>
                  IPHONECASEOBERA será responsable por cualquier defecto en la prestación
            ...
            <Accordion expanded={expanded === "panel7"} onChange={handleChange("panel7")}>
              ...
              <AccordionDetails>
                <Typography>
                  IPHONECASEOBERA podrá cobrar por sus servicios y la Persona Usuaria se
                  ...
                  <br />
                  <br />
                  La Persona Usuaria autoriza a IPHONECASEOBERA a retener y/o debitar los
            ...
            <Accordion expanded={expanded === "panel8"} onChange={handleChange("panel8")}>
              ...
              >
                <Typography fontWeight={"bold"}>Propiedad Intelectual</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  IPHONECASEOBERA y/o sus sociedades relacionadas son propietarias de
                  todos los derechos de propiedad intelectual sobre sus sitios, todo su
                  ...
                  internacionales.
                  <br />
                  Aunque IPHONECASEOBERA otorga permiso para usar sus productos y
                  ...
                  consentimiento previo y expreso de IPHONECASEOBERA y/o sus sociedades
                  vinculadas.
                  <br />
                  ...
                  o pérdidas a IPHONECASEOBERA y/o a sus sociedades relacionadas. La
                  utilización de los productos y servicios de IPHONECASEOBERA tampoco
                  implica la autorización para usar propiedad intelectual de terceros que
                  pueda estar involucrada, cuyo uso quedará bajo exclusiva responsabilidad
                  del usuario. En caso que una Persona Usuaria infrinja la Propiedad
                  Intelectual de IPHONECASEOBERA o de terceros, IPHONECASEOBERA podrá,
            ...
            >
              ...
              >
                <Typography fontWeight={"bold"}>Jurisdicción y Ley Aplicable</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  ...
                  Términos y Condiciones y con el uso del sitio, IPHONECASEOBERA con CUIT
                  23-371165479 establece como domicilio Sarratea 371, Ciudad de Obera,
                  Misiones, Argentina.
                </Typography>
              </AccordionDetails>
            </Accordion>
