...
import { getCartItemsAction, getFavsItemsAction } from "../../redux/actions/cart";
...
export default function CartFav({ type, onClose }) {
  ...
  const renderProductList = (products) => {
    if (products.length === 0) {
      return (
        <p className='text-center text-gray-500'>No hay productos en esta sección.</p>
      );
    }
